...
cube3d.base_cases[13].mc33.append(Triangulation())
cube3d.base_cases[13].mc33[2].faces = permute_geom_list(2, cube3d.base_cases[13].mc33[1].faces, Permutation(1, (2, 3, 0, 1, 6, 7, 4, 5)))
cube3d.base_cases[13].mc33[2].cells = permute_geom_list(3, cube3d.base_cases[13].mc33[1].cells, Permutation(1, (2, 3, 0, 1, 6, 7, 4, 5)))
