...
cube3d.base_cases[0].exterior = [[0, 1, 2, 3, 4, 5, 6, 7]]
cube3d.base_cases[0].interior = [[]]
# 1,0,0,0,0,0,0,0 -> 00000001 # Basic Case 1
cube3d.base_cases[1].name = "MC33 Case 1"
cube3d.base_cases[1].faces = [[(0, 4), (0, 1), (0, 2)]]
cube3d.base_cases[1].exterior = [[(0, 4), (0, 1), (0, 2), 4, 1, 2], [1, 5, 2, 6, 4], [1, 2, 3, 5, 6, 7]]
cube3d.base_cases[1].interior = [[0, (0, 4), (0, 1), (0, 2)]]
# 1,1,0,0,0,0,0,0 -> 00000011 # Basic Case 2
cube3d.base_cases[2].name = "MC33 Case 2"
cube3d.base_cases[2].faces = [[(0, 2), (1, 3), (0, 4), (1, 5)]]
cube3d.base_cases[2].exterior = [[(0, 2), (1, 3), (0, 4), (1, 5), 2, 3, 4, 5], [2, 4, 6, 3, 5, 7]]
cube3d.base_cases[2].interior = [[0, (0, 2), (0, 4), 1, (1, 3), (1, 5)]]
...
cube3d.base_cases[3].exterior = [[(1, 5), (0, 1), (1, 3), 5, 0, 3], [(2, 3), (0, 2), (2, 6), 3, 0, 6], [0, 3, 4, 7, 5], [0, 3, 4, 7, 6]]
cube3d.base_cases[3].interior = [[1, (1, 5), (0, 1), (1, 3)], [2, (2, 3), (0, 2), (2, 6)]]
...
cube3d.base_cases[4].exterior = [[(0, 4), (1, 5), (2, 6), 4, 5, 6], [(1, 5), 3, (2, 6), 5, 7, 6], [(1, 3), (1, 5), (2, 3), (2, 6), 3]]
cube3d.base_cases[4].interior = [[0, 1, 2, (0, 4), (1, 5) , (2, 6)], [1, (1, 3), (1, 5), 2, (2, 3), (2, 6)]]
...
cube3d.base_cases[5].exterior = [[(0, 4), (1, 5), (2, 6), (3, 7), 4, 5, 6, 7]]
cube3d.base_cases[5].interior = [[0, 1, 2, 3, (0, 4), (1, 5), (2, 6), (3, 7)]]
...
cube3d.base_cases[6].exterior = [[(0, 1), (1, 3), (1, 5), (0, 2), (2, 3), (2, 6)], [(1, 5), 5, (4, 5), (2, 6), 6, (4,6)], [0, (0, 1), (0, 2), (0, 4), (4, 5), (4, 6)], [(0, 1), (1, 5), (4, 5), (0, 2), (2, 6), (4, 6)], [(1, 5), 3, (2,6), 5, 7, 6], [(1, 3), (1, 5), (2, 3), (2, 6), 3]]
cube3d.base_cases[6].interior = [[1, (0, 1), (1, 3), (1, 5)], [2, (0, 2), (2, 6), (2, 3)], [4, (0, 4), (4, 5), (4, 6)]]
...
cube3d.base_cases[3].mc33[-1].exterior = [[(0, 2), (2, 6), 6, (0, 1), (1, 5), 5], [(2, 6), (2, 3), 6, (1, 5), (1, 3), 5], [(0, 1), (0, 2), 0, 5, 6, 4], [(1, 3), (2, 3), 3, 5, 6, 7]]
cube3d.base_cases[3].mc33[-1].interior = [[1, (0, 1), (1, 5), (1, 3)], [2, (0, 2), (2, 6), (2, 3)], [(0, 1), (1, 5), (1, 3), (0, 2), (2, 6), (2, 3)]]
...
# cube3d.base_cases[6].mc33[-1].faces = [[(0, 4), (4, 5), (4, 6)], [(1, 5), (2, 6), (1, 3), (2, 3)], [(0, 1), (0, 2), (1, 5), (2, 6)]]
# cube3d.base_cases[6].mc33[-1].cells = [[(1, 3), 3, (2, 3), 5, 7, 6], [(1, 3), (1, 5), 5, (2, 3), (2, 6), 6], [(0, 1), (1, 5), 5, (0, 2), (2, 6), 6], [(0, 1), (4, 5), 5, (0, 2), (4, 6), 6], [(4, 5), (4, 6), (0, 4), (0, 1), (0, 2), 0]]
...
# #cube3d.base_cases[6].mc33[-1].cells = permute_geom_list(3, cube3d.base_cases[6].mc33[1].cells, MIRROR_FACES_0_TO_2)
# # 0,1,1,0,1,0,0,0 -> 00010110 # MC33 Case 7.3 (face 0 connection)
# cube3d.base_cases[6].mc33.append(Triangulation())
# cube3d.base_cases[6].mc33[-1].name = "MC33 Case 7.3"
# cube3d.base_cases[6].mc33[-1].faces = [[(0, 1), (0, 2), (5, 1), (0, 7)], [(0, 2), (0, 7), (4, 0), (5, 4)], [(5, 4), (0, 7), (4, 6), (6, 2)], [(6, 2), (0, 7), (3, 2), (1, 3)], [(5, 1), (1, 3), (0, 7)]]
# cube3d.base_cases[6].mc33[-1].cells = [[0, (0, 4), (0, 2), (0, 7)], [0, (0, 2), (1, 0), (4, 0), (0, 7), (5, 1)], [(5, 1), (5, 4), (4, 0), (0, 7)], [5, 7, (0, 7), (5, 4)], [(4, 6), 7, (0, 7), (5, 4)], [(4, 6), 6, (0, 7), 7], [(4, 6), (6, 2), (0, 7), 6], [(4, 6), 7, (0, 7), 6], [7, (3, 2), (2, 6), 6, (0, 7)], [(1, 3), 3, (0, 7), (3, 2)], [(1, 3), 3, (0, 7), 7], [(3, 2), 3, (0, 7), 7], [(5, 1), (5, 4), 5, (1, 3), (0, 7), 7]]
...
# #cube3d.base_cases[6].mc33[-1].cells = permute_geom_list(3, cube3d.base_cases[6].mc33[3].cells, ROTATE_FACES_0_2_4)
...
# #cube3d.base_cases[6].mc33[-1].cells = permute_geom_list(3, cube3d.base_cases[6].mc33[4].cells, ROTATE_FACES_0_2_4)
# # 0,1,1,0,1,0,0,0 -> 00010110 # MC33 Case 7.4.1
# cube3d.base_cases[6].mc33.append(Triangulation())
# cube3d.base_cases[6].mc33[-1].name = "MC33 Case 7.4.1"
# cube3d.base_cases[6].mc33[-1].faces = [[(2, 3), (1, 3), (2, 6), (1, 5)], [(2, 6), (1, 5), (4, 6), (4, 5)], [(0, 1), (0, 2), (0, 4)]]
# cube3d.base_cases[6].mc33[-1].cells = [[(2, 3), (1, 3), 3, 6, 5, 7], [6, (2, 6), (2, 3), 5, (1, 5), (1, 3)], [(4, 6), (2, 6), 6, (4, 5), (1, 5), 5], [0, (0, 1), (0, 2), (0, 4)]]
# # 0,1,1,0,1,0,0,0 -> 00010110 # MC33 Case 7.4.2 ()
# cube3d.base_cases[6].mc33.append(Triangulation())
# cube3d.base_cases[6].mc33[-1].name = "MC33 Case 7.4.2"
# cube3d.base_cases[6].mc33[-1].faces = [[(0, 1), (1, 3), (1, 5)], [(0, 1), (0, 2), (1, 3), (2, 3)], [(0, 2), (2, 6), (2, 3)], [(0, 2), (0, 4), (2, 6), (4, 6)], [(0, 4), (4, 5), (4, 6)], [(0, 1), (0, 4), (1, 5), (4, 5)]]
# cube3d.base_cases[6].mc33[-1].cells = cube3d.base_cases[6].cells
