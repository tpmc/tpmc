...
cube3d.base_cases[6].mc33.append(Triangulation())
cube3d.base_cases[6].mc33[6].faces = [[(2, 3), (1, 3), (2, 6), (1, 5)], [(2, 6), (1, 5), (4, 6), (4, 5)], [(0, 1), (0, 2), (0, 4)]]#, MIRROR_FACES_0_TO_1), MIRROR25)
cube3d.base_cases[6].mc33[6].cells = [[(2, 3), (1, 3), 3, 6, 5, 7], [6, (2, 6), (2, 3), 5, (1, 5), (1, 3)], [(4, 6), (2, 6), 6, (4, 5), (1, 5), 5], [0, (0, 1), (0, 2), (0, 4)]]#, MIRROR_FACES_0_TO_1), MIRROR25)
...
cube3d.base_cases[16].mc33.append(Triangulation())
cube3d.base_cases[16].mc33[7].faces = permute_geom_list(2, cube3d.base_cases[16].mc33[0].faces, Permutation(-1, (0, 2, 1, 6, 4, 5, 3, 7)))
cube3d.base_cases[16].mc33[7].cells = permute_geom_list(3, cube3d.base_cases[16].mc33[0].cells, Permutation(-1, (0, 2, 1, 6, 4, 5, 3, 7)))
# 1,0,0,1,0,1,1,0 -> 01101001 # MC33 Case 13.3 (face 0, 2, 3, 4 connection; 1, 5 missing)
cube3d.base_cases[16].mc33.append(Triangulation())
cube3d.base_cases[16].mc33[8].faces = permute_geom_list(2, cube3d.base_cases[16].mc33[0].faces, Permutation(1, (3, 2, 1, 0, 7, 6, 5, 4)))
cube3d.base_cases[16].mc33[8].cells = permute_geom_list(3, cube3d.base_cases[16].mc33[0].cells, Permutation(1, (3, 2, 1, 0, 7, 6, 5, 4)))
# 1,0,0,1,0,1,1,0 -> 01101001 # MC33 Case 13.3 (face 0, 1, 2, 4 connection; 3, 5 missing)
cube3d.base_cases[16].mc33.append(Triangulation())
cube3d.base_cases[16].mc33[9].faces = permute_geom_list(2, cube3d.base_cases[16].mc33[0].faces, Permutation(-1, (2, 3, 0, 1, 6, 7, 4, 5)))
...
cube3d.base_cases[16].mc33[11].cells = permute_geom_list(3, cube3d.base_cases[16].mc33[0].cells, Permutation(1, (7, 5, 6, 4, 3, 1, 2, 0)))
# 1,0,0,1,0,1,1,0 -> 01101001 # MC33 Case 13.3 (face 0, 1, 3, 5 connection; 2, 4 missing)
cube3d.base_cases[16].mc33.append(Triangulation())
cube3d.base_cases[16].mc33[12].faces = permute_geom_list(2, cube3d.base_cases[16].mc33[0].faces, Permutation(-1, (4, 5, 6, 7, 0, 1, 2, 3)))
cube3d.base_cases[16].mc33[12].cells = permute_geom_list(3, cube3d.base_cases[16].mc33[0].cells, Permutation(-1, (4, 5, 6, 7, 0, 1, 2, 3)))
# 1,0,0,1,0,1,1,0 -> 01101001 # MC33 Case 13.3 (face 0, 1, 2, 5 connection; 3, 4 missing)
cube3d.base_cases[16].mc33.append(Triangulation())
cube3d.base_cases[16].mc33[13].faces = permute_geom_list(2, cube3d.base_cases[16].mc33[0].faces, Permutation(1, (6, 7, 4, 5, 2, 3, 0, 1)))
cube3d.base_cases[16].mc33[13].cells = permute_geom_list(3, cube3d.base_cases[16].mc33[0].cells, Permutation(1, (6, 7, 4, 5, 2, 3, 0, 1)))
# 1,0,0,1,0,1,1,0 -> 01101001 # MC33 Case 13.3 (face 1, 2, 4, 5 connection; 0, 3 missing)
cube3d.base_cases[16].mc33.append(Triangulation())
cube3d.base_cases[16].mc33[14].faces = permute_geom_list(2, cube3d.base_cases[16].mc33[0].faces, Permutation(1, (7, 3, 5, 1, 6, 2, 4, 0)))
cube3d.base_cases[16].mc33[14].cells = permute_geom_list(3, cube3d.base_cases[16].mc33[0].cells, Permutation(1, (7, 3, 5, 1, 6, 2, 4, 0)))
# 1,0,0,1,0,1,1,0 -> 01101001 # MC33 Case 13.3 (face 0, 2, 4, 5 connection; 1, 3 missing)
cube3d.base_cases[16].mc33.append(Triangulation())
cube3d.base_cases[16].mc33[15].faces = permute_geom_list(2, cube3d.base_cases[16].mc33[0].faces, Permutation(1, (2, 6, 0, 4, 3, 7, 1, 5)))
cube3d.base_cases[16].mc33[15].cells = permute_geom_list(3, cube3d.base_cases[16].mc33[0].cells, Permutation(1, (2, 6, 0, 4, 3, 7, 1, 5)))
# 1,0,0,1,0,1,1,0 -> 01101001 # MC33 Case 13.3 (face 0, 3, 4, 5 connection; 1, 2 missing)
cube3d.base_cases[16].mc33.append(Triangulation())
cube3d.base_cases[16].mc33[16].faces = permute_geom_list(2, cube3d.base_cases[16].mc33[0].faces, Permutation(-1, (0, 4, 2, 6, 1, 5, 3, 7)))
cube3d.base_cases[16].mc33[16].cells = permute_geom_list(3, cube3d.base_cases[16].mc33[0].cells, Permutation(-1, (0, 4, 2, 6, 1, 5, 3, 7)))
